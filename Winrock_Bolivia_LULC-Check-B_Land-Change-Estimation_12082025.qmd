...
terra::writeRaster(NIR08_2019, file.path(local_path, "Bolivia-2019", "NIR08_2019.tif"), overwrite=T)
...
terra::writeRaster(RED_2018, file.path(local_path, "Bolivia-2018", "RED_2018.tif"), overwrite=T)
...
#| echo: false
aoi_cropper = sf::st_transform(aoi_project, "EPSG:4326") 
BLUE_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_BLUE_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_BLUE_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_BLUE_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_BLUE_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_BLUE_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_BLUE_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_BLUE_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_BLUE_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
BLUE_2018 = terra::mosaic(BLUE_2018_NW, BLUE_2018_NE, BLUE_2018_SE, BLUE_2018_SW)
BLUE_2019 = terra::mosaic(BLUE_2019_NW, BLUE_2019_NE, BLUE_2019_SE, BLUE_2019_SW)
names(BLUE_2018) = "BLUE_2018"
names(BLUE_2019) = "BLUE_2019"
...
GREEN_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_GREEN_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_GREEN_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_GREEN_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_GREEN_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_GREEN_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_GREEN_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_GREEN_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_GREEN_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
GREEN_2018 = terra::mosaic(GREEN_2018_NW, GREEN_2018_NE, GREEN_2018_SE, GREEN_2018_SW)
GREEN_2019 = terra::mosaic(GREEN_2019_NW, GREEN_2019_NE, GREEN_2019_SE, GREEN_2019_SW)
names(GREEN_2018) = "GREEN_2018"
names(GREEN_2019) = "GREEN_2019"
...
NIR08_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_NIR08_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_NIR08_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_NIR08_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_NIR08_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_NIR08_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_NIR08_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_NIR08_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_NIR08_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
NIR08_2018 = terra::mosaic(NIR08_2018_NW, NIR08_2018_NE, NIR08_2018_SE, NIR08_2018_SW)
NIR08_2019 = terra::mosaic(NIR08_2019_NW, NIR08_2019_NE, NIR08_2019_SE, NIR08_2019_SW)
names(NIR08_2018) = "NIR08_2018"
names(NIR08_2019) = "NIR08_2019"
...
RED_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_RED_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_RED_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_RED_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_RED_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_RED_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_RED_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_RED_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_RED_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
RED_2018 = terra::mosaic(RED_2018_NW, RED_2018_NE, RED_2018_SE, RED_2018_SW)
RED_2019 = terra::mosaic(RED_2019_NW, RED_2019_NE, RED_2019_SE, RED_2019_SW)
names(RED_2018) = "RED_2018"
names(RED_2019) = "RED_2019"
...
SWIR16_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR16_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR16_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR16_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR16_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR16_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR16_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR16_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR16_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR16_2018 = terra::mosaic(SWIR16_2018_NW, SWIR16_2018_NE, SWIR16_2018_SE, SWIR16_2018_SW)
SWIR16_2019 = terra::mosaic(SWIR16_2019_NW, SWIR16_2019_NE, SWIR16_2019_SE, SWIR16_2019_SW)
names(SWIR16_2018) = "SWIR16_2018"
names(SWIR16_2019) = "SWIR16_2019"
...
SWIR22_2018_NW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR22_2018-02-12-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2018_NE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR22_2018-02-12-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2018_SE = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR22_2018-02-12-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2018_SW = terra::rast(file.path(local_path, "Bolivia-2018", "LC08_001067_SWIR22_2018-02-12-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2019_NW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR22_2019-01-14-NW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2019_NE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR22_2019-01-14-NE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2019_SE = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR22_2019-01-14-SE.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2019_SW = terra::rast(file.path(local_path, "Bolivia-2019", "LC08_001067_SWIR22_2019-01-14-SW.tif")) |> terra::crop(aoi_country, mask=T) |> terra::trim()
SWIR22_2018 = terra::mosaic(SWIR22_2018_NW, SWIR22_2018_NE, SWIR22_2018_SE, SWIR22_2018_SW)
SWIR22_2019 = terra::mosaic(SWIR22_2019_NW, SWIR22_2019_NE, SWIR22_2019_SE, SWIR22_2019_SW)
names(SWIR22_2018) = "SWIR22_2018"
names(SWIR22_2019) = "SWIR22_2019"
...
RED_2018		= terra::rast(file.path(local_path, "Bolivia-2018", "RED_2018.tif"))
RED_2019		= terra::rast(file.path(local_path, "Bolivia-2019", "RED_2019.tif"))
...
```{r}
#| echo: false
samples = sf::st_read(file.path(local_path, "Training-Samples", "glance_training_charagua.shp"), quiet=T)
...
partitioned_data_2019 <- stratified_partition(samples_signatures_2019, group_col="ipcc_label", train_ratio=0.7)
...
trainData_2019 = performanceEstimation::smote(ipcc_label ~ .,data=trainData_2019,perc.over=30,perc.under=30)
testData_2018 = performanceEstimation::smote(ipcc_label ~ .,data=testData_2018,perc.over=30,perc.under=30)
testData_2019 = performanceEstimation::smote(ipcc_label ~ .,data=testData_2019,perc.over=30,perc.under=30)
...
trainData_2019 <- trainData_2019 |> group_by(ipcc_label) |> mutate(across(where(is.numeric),
    ~ ifelse(is.na(.), median(., na.rm = T), .))) |> ungroup()

testData_2018 <- testData_2018 |> group_by(ipcc_label) |> mutate(across(where(is.numeric),
    ~ ifelse(is.na(.), median(., na.rm = T), .))) |> ungroup()
testData_2019 <- testData_2019 |> group_by(ipcc_label) |> mutate(across(where(is.numeric),
    ~ ifelse(is.na(.), median(., na.rm = T), .))) |> ungroup()
...
LULC_2019 = terra::rast(local_path, "Classified", "LULC_2019.tif") |> 
  terra::project(crs_project) |> terra::crop(aoi_project, mask=T) |> terra::trim()
